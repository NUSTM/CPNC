...
if datasets_name == 'ConceptNet':
    f = open('./data/ConceptNet/train.txt', 'r', encoding = 'utf-8')
elif datasets_name == 'Atomic':
    f = open('./data/atomic/train.preprocessed.txt', 'r', encoding = 'utf-8')
...
if datasets_name == 'ConceptNet':
    file_name = './data/ConceptNet/train.txt'
    val_file_name = './data/ConceptNet/valid.txt'
    test_file_name = './data/ConceptNet/test.txt'
elif datasets_name == 'Atomic':
    file_name = './data/atomic/train.preprocessed.txt'
    val_file_name = './data/atomic/valid.preprocessed.txt'
    test_file_name = './data/atomic/test.preprocessed.txt'
