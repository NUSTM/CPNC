...
f = open('./data/ConceptNet/cn_node_names.txt', 'r', encoding = 'utf-8')
data = f.readlines()
nodes = []
for line in data:
...
EB_forward = torch.load('./bert_model_embeddings/nodes-lm-conceptnet/conceptnet_bert_embeddings.pt')
...
f = open('./Concept_Centre/ConceptNet/nodes_index_to_cluster_index.json', 'w')
json.dump(nodes_index_to_cluster_index, f)
f.close()

# cluster_centers
torch.save(cluster_centers, './Concept_Centre/ConceptNet/cluster_centers.pt')
