...
class BertLayer(nn.Module):
    def __init__(self, dataset):
        ...
        self.bert_model = BertModel.from_pretrained( '/root/ConstractiveSentenceBert/output/training_nli_v2_bert-large-uncased-2022-10-13_14-16-58/' )
...
#
        ...
        for input_ids, input_mask, segment_ids in eval_dataloader:
            ...
            with torch.no_grad():
                #sequence_output_xxs = self.bert_model.bert(input_ids, segment_ids, input_mask)
                sequence_output_xxs = self.bert_model(input_ids, segment_ids, input_mask)
                sequence_output = sequence_output_xxs['last_hidden_state']
                
            sequence_outputs.append(sequence_output[:, 0])
            print(len(sequence_outputs))
    ...
    def save_to_disk(self, tensor, idx):
        print(self.dataset + str(idx) + "_bert_embeddings.pt")
