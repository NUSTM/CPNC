...
f = open('./data/atomic/atomic_node_names.txt', 'r', encoding = 'utf-8')
...
torch.save(all_nodes_features, './bert_model_embeddings/nodes-lm-atomic/atomic_bert_embeddings.pt', _use_new_zipfile_serialization=False)